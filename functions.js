...
function createPhrasesChaves() {
  console.log('Ninguém tem paciência comigo.')
  console.log('A vingança nunca é plena, mata a alma e a envenena.')
  console.log('As pessoas boas devem amar seus inimigos.')
  console.log('Não existe trabalho ruim, o ruim é ter que trabalhar.')
...
console.log('Lista com 5 pokémons:')
...
console.log('Lista com 5 livros:')

function listBooks() {
  console.log('O Mundo Assombrado pelos Demônios')
  console.log('Astrofísica para Apressados')
  console.log('O Físico')
  console.log('O Céu da Meia-noite')
  console.log('Um Lugar Bem Longe Daqui')
}
...
console.log('Lista com 5 séries:')
...
console.log('Início da lista de 5 filmes:')

function listMovies() {
  console.log('A Chegada (2016)')
  console.log('A Noite do Jogo (2018)')
  console.log('Brilho Eterno de Uma Mente Sem Lembranças (2004)')
  console.log('Persuasão (2007)')
  console.log('Skiptrace (2016)')
}
...
console.log('Início da lista com 5 bebidas:')
...
console.log('Início da lista com 5 doenças:')

function listSick() {
  console.log('1. Covid-19')
  console.log('2. Diabetes')
  console.log('3. Câncer')
  console.log('4. Varíola')
  console.log('5. Gastrite')
}
...
console.log('Início da lista com 5 times brasileiros:')

function brazilianTimes() {
  console.log('1. Palmeiras')
  console.log('2. Corinthians')
  console.log('3. Chapecoense')
  console.log('4. Fluminense')
  console.log('5. Botafogo')
}
...
console.log('Início da lista com 5 times argentinos:')
...
console.log('Início da lista de 5 times italianos:')

function italianTeams() {
  console.log('1. Inter de Milão')
  console.log('2. Milan')
  console.log('3. Lazio')
  console.log('4. Parma')
  console.log('5. Juventus')
}
...
console.log('Início da lista de 5 times alemães:')

function germansTeams() {
  console.log('1. Borussia Dortmund')
  console.log('2. Bayern de Munique')
  console.log('3. RB Leipzig')
  console.log('4. Eintracht Frankfurt')
  console.log('5. FC Schalke 04')
}
...
console.log('Início da lista com 5 times ingleses:')

function englishTeams() {
  console.log('1. Manchester United')
  console.log('2. Manchester City')
  console.log('3. Leicester City')
  console.log('4. Arsenal')
  console.log('5. Liverpool')
}
...
console.log('Início da lista com 5 times espanhóis:')

function spanishTeams() {
  console.log('1. Atlético de Madrid')
  console.log('2. Real Madrid')
  console.log('3. Barcelona')
  console.log('4. Valencia')
  console.log('5. Betis')
}
...
console.log('Início da lista com 5 cores')
...
console.log('Continução de mais 5 cores')

function moreColors() {
  console.log('6. White')
  console.log('7. Purple')
  console.log('8. Black')
  console.log('9. Gray')
  console.log('10. Lemon')
}
...
console.log('Início da lista com 5 desenhos animados')

function fiveCartoons() {
  console.log('1. As Meninas Superpoderosas')
  console.log('2. As Aventuras de Jackie Chan')
  console.log('3. Hora de Aventura')
  console.log('4. Apenas um Show')
  console.log('5. Titio Avô')
}
...
console.log('Crie uma lista com Bulbasaur e suas evoluções:')

function evolutionBulbasaur() {
  console.log('1. Bulbasaur')
  console.log('2. Ivysaur')
  console.log('3. Venosaur')
}
...
console.log('Crie uma lista com Squirtle e suas evoluções:')

function evolutionSquirtle() {
  console.log('1. Squirtle')
  console.log('2. Wartortle')
  console.log('3. Blastoise')
}
...
console.log('Crie uma lista com Pichu e suas evoluções:')

function evolutionsPichu() {
  console.log('1.Pichu')
  console.log('2. Pikachu')
  console.log('3. Raichu')
}
...
console.log('Crie uma lista com Dratini e suas evoluções:')

function evolutionsDratini() {
  console.log('1. Dratini')
  console.log('2. Dragonair')
  console.log('3. Dragonite')
}
...
console.log('Crie uma lista com 5 games:')

function listGames() {
  console.log('1. Orna')
  console.log('2. Grand Theft Auto')
  console.log('3. Alien - Isolation')
  console.log('4. Ragnarok')
  console.log('5. Pokémon Go')
}
...
console.log('Criar uma lista com 5 consoles:')

function listConsoles() {
  console.log('1. Playstation')
  console.log('2. Super Nintendo')
  console.log('3. Mega Drive')
  console.log('4. X-box')
  console.log('5. Dreamcast')
}
...
console.log('Lista com 5 nomes de bandas')

function fiveBands() {
  console.log('1. Dream Theater')
  console.log('2. Sons of Apollo')
  console.log('3. Megadeth')
  console.log('4. The Smiths')
  console.log('5. Mamonas Assassinas')
}
...
console.log('Para que serve uma function? Cite três exemplos:')

function exemplosTrês() {
  console.log('1. Agrupamento de códigos')
  console.log('2. Reutilização do código')
...
console.log('Para que ser uma function? Cite três exemplos:')

function exemplosFunction1() {
  console.log('1. Agrupamento de códigos')
  console.log('2. Reutilização do código')
  console.log('3. Dar significado a um bloco de código')
}
...
console.log('Para que ser uma function?')

function exemplosFunction2() {
  console.log('1. Agrupamento de códigos')
...
console.log('Citê três função de uma "function":')

function exemplosFunction3() {
  console.log('1. Agrupamento de códigos')
  console.log('2. Reutilização de código')
  console.log('3. Dar significado a um bloco de código')
}
